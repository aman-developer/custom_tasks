...
function ImagePosition(variant){
  var imageposition = $('#ProductSelect--product-template option[value="'+variant.id+'"]').data('image-positions');
  var imagepositionsarr = imageposition.split(',');
  $('.product-single__thumbnails li').hide();
  $.each(imagepositionsarr, function(index, position){
    $('.product-single__thumbnails li[data-image-position="'+position+'"]').show();
  });
...
$(document).ready(function(){
  var accordionContent = $('.faq_ans');
  var accordianHeading = $('.faq_qstn');
